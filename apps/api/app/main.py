...
from app.routers import analyze, auth, billing, candidates, contact, events, outreach, roles, shortlists, uploads, workspaces
...
def create_app() -> FastAPI:
    ...
    app.include_router(shortlists.router, prefix=API_PREFIX)
